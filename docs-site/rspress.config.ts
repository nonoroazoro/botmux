...
const zhSidebar = [
  ...
  },
  {
    ...
    items: [
      ...
      { text: 'Knowledge / Skill / Workflow', link: '/workflow' },
...
const enSidebar = [
  ...
  },
  {
    ...
    items: [
      ...
      { text: 'Bot Personality', link: '/en/personality' },
      ...
      { text: 'Knowledge / Skill / Workflow', link: '/en/workflow' },
