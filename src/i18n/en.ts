...
export const messages: Record<string, string> = {
  ...
  'card.repo.note': "Reply `/repo <N>` to switch projects, or `/repo <path|name>` to open one directly. `/repo wt <N|name> [branch]` creates a worktree from the remote default branch.",
  ...
  'card.grant.requested_group': 'I sent an access request to the owner. Once approved, I will continue with your message in this topic.',
  'card.grant.requested_p2p': 'I sent an access request to the owner. Once approved, I will continue with your message.',
  'card.grant.request_failed': 'I could not send an access request to the owner. Please try again later.',
  ...
  'card.grant.btn_group': 'Grant the group above',
  'card.grant.btn_p2p': 'Grant this direct chat',
  ...
  'card.grant.note_group': 'This grant applies only to group chat **{chat}**. Access is revoked when either limit is reached; /restart, /close, terminal write and other sensitive ops remain limited to allowedUsers (owner).',
  'card.grant.note_p2p': 'This grant applies only to the direct conversation between this user and me. Access is revoked when either limit is reached; /restart, /close, terminal write and other sensitive ops remain limited to allowedUsers (owner).',
  ...
  'card.grant.result_group': '✅ Granted for group chat **{chat}**',
  'card.grant.result_p2p': '✅ Granted for this direct conversation',
  ...
  'card.codex_app_thread.title': '📱 Choose a Codex Desktop conversation',
  'card.codex_app_thread.subtitle': "Choose a previous Codex conversation to continue.",
  'card.codex_app_thread.placeholder_select': 'Pick a Codex Desktop conversation',
  ...
  'cmd.term.unsupported': "This session has no Web Terminal. Open a ZMX session on the host with `zmx attach`.",
  ...
  'cmd.rename.updated_requested': '✅ Session title updated: {title}\n↪ Sent a native rename request to {cliName}.',
  'cmd.rename.updated_not_running': '✅ Session title updated: {title}\nThe agent is not running, so its native session name was not changed.',
  'cmd.rename.updated_unsupported': '✅ Session title updated: {title}\n{cliName} does not support native session-name sync yet.',
  'cmd.rename.updated_failed': '⚠️ Session title updated: {title}\nFailed to send the native rename request to {cliName}.',
  ...
  'cmd.repo.working_dir_not_exist': "❌ The working directory is missing or is not a directory: {dirs}. Choose an existing directory in the bot settings.",
  'cmd.repo.no_git_repos': 'No git repositories found under {dirs}.',
  'cmd.repo.worktree_usage': 'Usage: `/repo wt <N|name|path> [new-branch]` — create a worktree off the repo\'s remote default branch and open it; without a branch, I name it from the topic title / first prompt when possible.',
  ...
  'cmd.watch.started_lazy': '✅ Registered a comment watch for doc {title}… ({mode}).\nNo session is bound yet. I will create a doc-native session and start the CLI when the first matching comment arrives.',
  'cmd.watch.deferred_start': 'No CLI is currently running. I will start the session automatically when the first matching doc comment arrives.',
  ...
  'cmd.watch.project_optional_session': 'No project is bound to this session. To use local code in answers, send `/cd <project directory>`; otherwise I will answer from the document only.',
  ...
  'cmd.watch.prewarm_failed': '⚠️ The comment watch is registered, but AI session warmup failed. I will try to start it again when a comment arrives.',
  ...
  'cmd.vc.prepared': 'The meeting preparation chat is ready.\nMeeting number: `{meetingNo}`\nAutomatic Q&A: `{qaMode}`\nAfter the meeting starts and the Bot is invited, I will reuse this group and its current Agent session. Add background here and run `/watch-comment <document link> --all` to pre-read and watch the presentation document.',
  ...
  'cmd.detach.not_adopted': 'This topic is not an /adopt session; /detach does not apply. Use /close to end the session (which also kills the CLI).',
  'cmd.codex_app_adopt.no_threads': 'No resumable Codex Desktop conversation found.',
  'cmd.codex_app_adopt.thread_not_found': 'Codex Desktop conversation not found: {threadId}',
  'cmd.codex_app_adopt.list_failed': 'Failed to read Codex Desktop conversations: {error}',
  'cmd.codex_app_adopt.success': '📱 Resumed Codex Desktop conversation: {title}',
  ...
  'cmd.config.no_owner': "⚠️ No administrator is configured, so settings cannot be changed from chat yet. Contact the deployment administrator to finish setup.",
  ...
  'cmd.relay.adopt_not_relayable': "⚠️ This session is attached to an external tmux via /adopt. Its lifecycle cannot be managed here, so it cannot be relayed.",
  ...
  'cmd.fork.unsupported_backend': 'ℹ️ The current {cli} session does not support fork yet (only Claude family / Codex terminal mode; Codex Desktop, RPC-enabled Codex, and pure-remote backends run an app-server live session with no byte-level copy).',
  ...
  'cmd.fork.child_intro': '[Forked session] This session was forked from the parent session "{parentTitle}" and inherits its complete context up to the fork point (parent sessionId: {parentSessionId}; parent topic root message id: {parentRootId}). Progress made in the parent after the fork is not synced here. Your task:',
  ...
  'schedule.silent_note': "Silent mode: no start notification. Send a message only when the alert condition is met.",
  'schedule.silent_new_topic_conflict': "A silent topic is created with the first alert. If there is no alert, the hidden session closes automatically.",
  ...
  'help.rename': '/rename <title> - Rename this session and sync the running Codex/Claude session name',
  ...
  'card.action.terminal_unsupported': "⚠️ This session has no Web Terminal. Open a ZMX session on the host with `zmx attach`.",
  ...
  'worker.input_delivery_failed': "⚠️ I could not deliver this message to the current session, including after retrying. I stopped retrying to avoid duplicate execution. Please resend it.\nRequest: {turnId}",
  'worker.start_exited_early': "The session exited before it was ready (exit code: {code}). Ask the administrator to check the runtime logs.",
  ...
  'worker.empty_final_completed': "⚠️ {cliName} reported completion, but I received no final text and detected no reply for this turn. If you already received the result, ignore this notice. Otherwise check the Web Terminal or send another message to continue.",
  ...
  'setup.supported_clis': 'Supported CLIs: claude-code, coco, codex, cursor, gemini, opencode, antigravity, mtr, hermes, codex-app, traex, pi, copilot, oh-my-pi, kimi, genius, grok, kiro-cli, reasonix',
  ...
  'setup.next_step_short': "Next: run botmux restart to apply the configuration.",
  'setup.next_start_daemon': "  1. Run botmux start before configuring the Lark connection.",
  'setup.next_autostart': "  2. Run botmux autostart enable to start at login ({platformName}; no sudo required).",
  ...
  'start.run_setup': "   Run botmux setup first.",
  ...
  'daemon.fast_unsupported_backend': "⚠️ /fast can't toggle Codex's tier on this session's backend because RPC input mode does not route keystrokes to the executor. The card badge still reflects the tier Codex is actually running.",
  ...
  'card.dashboard.schedules.delivery.disabled.silent': "A silent topic is created with the first alert",
  ...
  'card.ask.title': '{botName} · Choose an option',
  'card.ask.title_done': '{botName} · Choice completed',
  'card.ask.title_fallback': 'Choose an option',
  'card.ask.title_done_fallback': 'Choice completed',
  ...
  // Personal assistant artifacts
  'card.capability.type.knowledge': 'Knowledge',
  'card.capability.type.skill': 'Skill',
  'card.capability.type.workflow': 'Dynamic Workflow',
  'card.capability.title.personal.save': 'Choose how to save this {type}',
  'card.capability.title.personal.update': 'Choose how to update this {type}',
  'card.capability.title.bot.save': 'Confirm saving this {type} for the team',
  'card.capability.title.bot.update': 'Confirm updating this team {type}',
  'card.capability.title.contribution.publish': 'Confirm this team sharing request for a {type}',
  'card.capability.title.contribution.update': 'Confirm this team update request for a {type}',
  'card.capability.title.delete.personal': 'Confirm deleting this personal {type}',
  'card.capability.title.delete.bot': 'Decide whether to delete this team {type}',
  'card.capability.title.delete_request.pending': 'Team deletion request submitted',
  'card.capability.title.delete_request.accepted': 'Team deletion request approved',
  'card.capability.title.delete_request.rejected': 'Team deletion request rejected',
  'card.capability.field.type': 'Type',
  'card.capability.field.name': 'Name',
  'card.capability.field.description': 'Description',
  'card.capability.field.requester': 'Requester',
  'card.capability.field.reason': 'Reason',
  'card.capability.field.instructions': 'Instructions',
  'card.capability.field.workflow_trial_outcome': 'Agent trial assessment',
  'card.capability.field.workflow_trial_summary': 'Trial summary',
  'card.capability.workflow_trial_outcome.passed': 'Passed',
  'card.capability.workflow_trial_outcome.passed_with_limitations': 'Passed with limitations',
  'card.capability.note.personal': 'Nothing is saved until you confirm. Personal content is loaded only in your P2P bot sessions.',
  'card.capability.note.personal_workflow': 'Nothing is saved until you confirm. The current agent runs the workflow with its available tools.',
  'card.capability.note.bot': 'Nothing is saved for the team until you confirm. Team content applies to users of this bot.',
  'card.capability.note.contribution': 'Approval creates separate team content and does not change the contributor\'s personal copy.',
  'card.capability.note.delete': 'Deleting permanently removes this content and all of its revision history.',
  'card.capability.note.delete.bot': 'Only the bot owner can approve deletion. Deleting permanently removes this content and all revision history.',
  'card.capability.note.delete_request.pending': 'The request was sent to the bot owner. You will receive a separate result notification.',
  'card.capability.note.delete_request.accepted': 'The team content and all revision history have been deleted.',
  'card.capability.note.delete_request.rejected': 'The team content was not changed.',
  'card.capability.button.personal.save': 'Save for me',
  'card.capability.button.personal.update': 'Update for me',
  'card.capability.button.personal_contribute.save': 'Save for me and request team sharing',
  'card.capability.button.personal_contribute.update': 'Update for me and request team sharing',
  'card.capability.button.bot.save': 'Save for the team',
  'card.capability.button.bot.update': 'Update team content',
  'card.capability.button.contribution.publish': 'Approve team sharing',
  'card.capability.button.contribution.update': 'Approve team update',
  'card.capability.button.contribution.reject': 'Reject sharing',
  'card.capability.button.delete.personal': 'Delete personal content',
  'card.capability.button.delete.bot': 'Approve team deletion',
  'card.capability.button.delete.reject': 'Reject deletion request',
  'card.capability.button.cancel': 'Cancel',
  'card.capability.result.saved.personal': 'Saved to my assistant',
  'card.capability.result.saved.bot': 'Saved for the team',
  'card.capability.result.deleted.personal': 'Deleted personal content',
  'card.capability.result.deleted.bot': 'Deleted team content',
  'card.capability.result.cancelled': 'Save cancelled',
  'card.capability.result.delete_cancelled': 'Deletion cancelled',
  'card.capability.result.delete_rejected': 'Deletion request rejected',
  'card.capability.toast.stale': 'This action is no longer valid. Start it again.',
  'card.capability.toast.no_owner': 'This bot has no owner configured, so team sharing cannot be requested.',

  // Workflow trial card
  'card.workflow_trial.title': 'Choose how to handle this Workflow draft',
  'card.workflow_trial.title.run': 'Workflow trial confirmed',
  'card.workflow_trial.title.edit': 'Workflow draft will be revised',
  'card.workflow_trial.title.discard': 'Workflow draft discarded',
  'card.workflow_trial.title.timeout': 'Workflow trial confirmation timed out',
  'card.workflow_trial.title.invalid': 'Workflow trial confirmation expired',
  'card.workflow_trial.field.name': 'Name',
  'card.workflow_trial.field.description': 'Description',
  'card.workflow_trial.field.instructions': 'Workflow',
  'card.workflow_trial.note': 'This step only confirms a trial run. It does not save the Workflow. A save confirmation card appears after a successful trial.',
  'card.workflow_trial.button.run': 'Run once',
  'card.workflow_trial.button.discard': 'Discard',
  'card.workflow_trial.custom_reply_hint': '💬 Need changes? Reply in this topic with your revision request.',
  'card.workflow_trial.result.run': 'The agent will run one trial with its current tools. Save confirmation follows only after success.',
  'card.workflow_trial.result.discard': 'This draft will not be saved.',
  'card.workflow_trial.result.request': 'Revision request',

  // Artifact overlap card
  'card.artifact_overlap.title': 'Similar content found. Choose how to proceed',
  'card.artifact_overlap.title.update': 'Existing content will be updated',
  'card.artifact_overlap.title.separate': 'New content will be created separately',
  'card.artifact_overlap.title.cancel': 'Creation cancelled',
  'card.artifact_overlap.title.revise': 'New content will be revised',
  'card.artifact_overlap.title.timeout': 'Similarity decision timed out',
  'card.artifact_overlap.title.invalid': 'Similarity decision expired',
  'card.artifact_overlap.field.type': 'Type',
  'card.artifact_overlap.field.proposed': 'Proposed',
  'card.artifact_overlap.field.existing': 'Closest existing content',
  'card.artifact_overlap.field.summary': 'Overlap and differences',
  'card.artifact_overlap.button.update': 'Update existing',
  'card.artifact_overlap.button.separate': 'Create separately',
  'card.artifact_overlap.button.cancel': 'Cancel',
  'card.artifact_overlap.custom_reply_hint': '💬 Need another approach? Reply in this topic with your request.',
  'card.artifact_overlap.result.update': 'The agent will merge justified content into the existing artifact.',
  ...
  'worker.codex_composer_conflict': 'The adopted Codex terminal already has an unsubmitted local draft. I left that draft untouched and did not append the Lark message. Submit or clear the local draft, then resend the Lark message.',
  ...
  'worker.submit_unconfirmed_zmx': "⚠️ After {secs}s, I still cannot confirm delivery to {cliName}. Do not resend yet. Open the ZMX session on the host and inspect its input.\nMessage starts with: {preview}",
  'worker.zmx_recovery_pending': "The ZMX session state could not be confirmed, so automatic cleanup was skipped. Do not resend yet. Inspect the session on the host, clear its input with Ctrl+C, then use /restart.",
  'worker.zmx_recovery_unconfirmed': "I could not confirm that the ZMX input was cleared, so automatic input is paused to prevent duplicate or concatenated messages. Inspect and clear the input on the host, then use /restart.",
  ...
  'worker.interrupt_recovery_zmx': "Open the ZMX session on the host, inspect it, and interrupt it manually. If its state is still uncertain, use /restart.",
  ...
  'restart.updated_restarted': "🔄 **Updated and restarted**",
  'restart.rolled_back_restarted': "↩️ **Rolled back and restarted**",
  ...
  'restart.card_title': "Maintenance notice",

  // Host-side CLI runtime update monitor
  'cli_update.card_title': 'New {cli} version available',
  'cli_update.available': 'I found a new version of {cli}.',
  ...
  'cli_update.command': 'If you decide to upgrade, run this on the host: {command}',
  'cli_update.manual_only': "I will not upgrade automatically. Existing sessions are unaffected.",
  'cli_update.dashboard': 'Dashboard: {url}',

  // Auto-start (joined chat) member-read failure admin DM
  'daemon.auto_start_member_read_failed': "⚠️ I could not read the group members or confirm that an authorized user is present, so I did not start automatically.\n\nAsk the administrator to check the app permissions and bot-added event subscription, then restart the service.\n\nDetails: {detail}",
