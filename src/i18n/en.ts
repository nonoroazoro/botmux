...
export const messages: Record<string, string> = {
  ...
  'ai.shell.helpers': 'Helpers: `botmux history` (read the current session history), `botmux quoted <message_id>` (fetch a quoted message only when the prompt header shows `[user quoted message ...]`), `botmux bots list` (list currently available collaborator bots).',
