...
export const messages: Record<string, string> = {
  ...
  'card.repo.note': "也可以回复 `/repo <编号>` 切换（如 `/repo 1`），或用 `/repo <路径|项目名>` 直接打开项目；`/repo wt <编号|项目名> [分支名]` 会基于远端默认分支新建 worktree。",
  ...
  'card.grant.requested_group': '我已向 owner 发送授权申请。批准后，我会在本话题继续处理你的消息。',
  'card.grant.requested_p2p': '我已向 owner 发送授权申请。批准后，我会继续处理你的消息。',
  'card.grant.request_failed': '暂时无法向 owner 发送授权申请，请稍后重试。',
  ...
  'card.grant.btn_group': '授权上述群聊',
  'card.grant.btn_p2p': '授权该私聊',
  ...
  'card.grant.note_group': '本次授权仅适用于群聊 **{chat}**。有效期或消息额度任一先到即自动收回授权；/restart、/close、终端写入等敏感操作仍仅限 allowedUsers（owner）。',
  'card.grant.note_p2p': '本次授权仅适用于该用户与我的私聊。有效期或消息额度任一先到即自动收回授权；/restart、/close、终端写入等敏感操作仍仅限 allowedUsers（owner）。',
  ...
  'card.grant.result_group': '✅ 已授权在群聊 **{chat}** 中对话',
  'card.grant.result_p2p': '✅ 已授权该用户在与我的私聊中对话',
  ...
  'card.codex_app_thread.title': '📱 选择要继续的 Codex Desktop 对话',
  'card.codex_app_thread.subtitle': "选择要继续的 Codex 历史对话。",
  'card.codex_app_thread.placeholder_select': '选择 Codex Desktop 对话',
  ...
  'cmd.term.unsupported': "当前会话不支持 Web 终端。ZMX 会话可在宿主机通过 `zmx attach` 打开。",
  ...
  'cmd.new.accepted': '✅ 执行成功，下一条消息将开启新会话。',
  ...
  'cmd.rename.updated_requested': '✅ 会话标题已更新：{title}\n↪ 已向 {cliName} 发送原生改名请求。',
  'cmd.rename.updated_not_running': '✅ 会话标题已更新：{title}\nAgent 当前未运行，未修改其原生会话名。',
  'cmd.rename.updated_unsupported': '✅ 会话标题已更新：{title}\n{cliName} 暂不支持原生会话名同步。',
  'cmd.rename.updated_failed': '⚠️ 会话标题已更新：{title}\n向 {cliName} 发送原生改名请求失败。',
  ...
  'cmd.repo.working_dir_not_exist': "❌ 工作目录不存在或不是目录：{dirs}。请在机器人设置中选择一个已有目录。",
  ...
  'cmd.watch.deferred_start': '当前没有运行中的 CLI；首条符合条件的文档评论到来时，会自动启动会话。',
  ...
  'cmd.detach.not_adopted': '本话题不是 /adopt 接入的会话，/detach 不适用。要结束会话，请用 /close（会一并结束 CLI 进程）。',
  'cmd.codex_app_adopt.no_threads': '未发现可继续的 Codex Desktop 对话',
  'cmd.codex_app_adopt.thread_not_found': '未找到 Codex Desktop 对话 {threadId}',
  'cmd.codex_app_adopt.list_failed': '读取 Codex Desktop 对话失败：{error}',
  'cmd.codex_app_adopt.success': '📱 已继续 Codex Desktop 对话：{title}',
  ...
  'cmd.config.no_owner': "⚠️ 还没有配置管理员，暂时不能从聊天修改设置。请联系部署管理员完成配置。",
  ...
  'cmd.relay.adopt_not_relayable': "⚠️ 这个会话通过 /adopt 连接到外部 tmux，无法管理其生命周期，因此不能接力。",
  ...
  'cmd.fork.unsupported_backend': 'ℹ️ 当前 {cli} 会话暂不支持 fork（目前仅 Claude 系 / Codex 终端模式；Codex Desktop、开启 RPC 的 Codex、纯远端后端走 app-server 活会话，无法字节级复制）。',
  ...
  'cmd.fork.child_intro': '【分身会话】本会话由主会话「{parentTitle}」fork 而来，已继承 fork 时刻之前的完整上下文（父 sessionId：{parentSessionId}；父话题根消息 id：{parentRootId}）。fork 后主话题的新进展不会自动同步到这里。本次任务：',
  ...
  'schedule.silent_note': "静默模式：不发送开始提示，只在满足提醒条件时发消息。",
  'schedule.silent_new_topic_conflict': "静默新话题会在首次发送提醒时创建；没有提醒时自动关闭隐藏会话。",
  ...
  'help.rename': '/rename <标题> - 重命名当前会话，并同步运行中的 Codex/Claude 原生会话名',
  ...
  'slashlist.part_builtin': '① 固定放行（内置透传白名单）：',
  ...
  'card.action.terminal_unsupported': "⚠️ 当前会话不支持 Web 终端。ZMX 会话可在宿主机通过 `zmx attach` 打开。",
  ...
  'worker.input_delivery_failed': "⚠️ 这条消息还没能交给当前会话处理，自动重试也未成功。为避免重复执行，我没有继续重投。请重发这条消息。\n请求编号：{turnId}",
  'worker.start_exited_early': "会话在准备完成前退出了（退出码：{code}）。请联系管理员查看运行日志。",
  ...
  'worker.empty_final_completed': "⚠️ {cliName} 已报告处理完成，但我没有收到最终文本，也没有检测到本轮回复。如果你已收到结果，可以忽略这条提示；否则请打开 Web 终端查看，或再发一条消息继续。",
  ...
  'setup.supported_clis': '支持的 CLI: claude-code, coco, codex, cursor, gemini, opencode, antigravity, mtr, hermes, codex-app, traex, pi, copilot, oh-my-pi, kimi, genius, grok, kiro-cli, reasonix',
  ...
  'setup.next_step': '下一步:',
  'setup.next_step_short': "下一步：运行 botmux restart 使配置生效。",
  'setup.next_start_daemon': "  1. 运行 botmux start 启动服务，再配置飞书长连接。",
  'setup.next_autostart': "  2. 建议运行 botmux autostart enable 启用开机启动（{platformName}，无需 sudo）。",
  ...
  'start.run_setup': "   请先运行 botmux setup 完成机器人配置。",
  ...
  'daemon.fast_unsupported_backend': '⚠️ 这个会话的后端下 /fast 切不了 Codex 档位。RPC 输入模式不走终端，按键到不了执行端。卡片徽标仍会如实反映 Codex 实际运行的档位。',
  ...
  'card.dashboard.schedules.delivery.disabled.silent': "静默新话题将在首次发送提醒时创建",
  ...
  'settings.localCliOpenModeHelp': '默认附加当前会话：managed tmux / Herdr / ZMX 走精确 attach，adopt 会话只在已有可靠目标时附加；ZMX native attach 不提供 Web TUI。direct resume 适合明确接受飞书连续性风险的本机调试。',
  ...
  'card.ask.title': '{botName} · 请做选择',
  'card.ask.title_done': '{botName} · 选择已完成',
  'card.ask.title_fallback': '请做选择',
  'card.ask.title_done_fallback': '选择已完成',
  ...
  'card.capability.title.personal.save': '请选择如何保存这条 {type}',
  'card.capability.title.personal.update': '请选择如何更新这条 {type}',
  'card.capability.title.bot.save': '请确认是否将这条 {type} 保存到团队',
  'card.capability.title.bot.update': '请确认是否更新团队中的这条 {type}',
  'card.capability.title.contribution.publish': '请确认是否接受这条 {type} 的团队共享申请',
  'card.capability.title.contribution.update': '请确认是否接受这条 {type} 的团队更新申请',
  'card.capability.title.delete.personal': '请确认是否删除个人 {type}',
  'card.capability.title.delete.bot': '请决定是否删除团队 {type}',
  'card.capability.title.delete_request.pending': '团队删除申请已提交',
  'card.capability.title.delete_request.accepted': '团队删除申请已通过',
  'card.capability.title.delete_request.rejected': '团队删除申请已拒绝',
  'card.capability.field.type': '类型',
  'card.capability.field.name': '名称',
  'card.capability.field.description': '说明',
  'card.capability.field.requester': '申请人',
  'card.capability.field.reason': '删除原因',
  'card.capability.field.instructions': '内容',
  'card.capability.field.workflow_trial_outcome': 'Agent 试运行判断',
  'card.capability.field.workflow_trial_summary': '试运行摘要',
  'card.capability.workflow_trial_outcome.passed': '通过',
  'card.capability.workflow_trial_outcome.passed_with_limitations': '通过，但存在限制',
  'card.capability.note.personal': '确认后才会保存。个人内容仅在你与机器人的私聊会话中加载。',
  'card.capability.note.personal_workflow': '确认后才会保存。运行时由当前 agent 使用已有工具执行。',
  'card.capability.note.bot': '确认后才会保存到团队，并对使用此机器人的用户生效。',
  'card.capability.note.contribution': '同意后会创建独立的团队内容，不会修改贡献者的个人副本。',
  'card.capability.note.delete': '删除后，该内容及其全部历史版本都无法恢复。',
  'card.capability.note.delete.bot': '只有机器人 owner 可以确认删除。删除后，该内容及其全部历史版本都无法恢复。',
  'card.capability.note.delete_request.pending': '申请已发送给机器人 owner，处理结果会另行通知。',
  'card.capability.note.delete_request.accepted': '团队内容及其全部历史版本已删除。',
  'card.capability.note.delete_request.rejected': '团队内容未发生变化。',
  'card.capability.button.personal.save': '保存到个人',
  'card.capability.button.personal.update': '更新个人内容',
  'card.capability.button.personal_contribute.save': '保存到个人并申请共享给团队',
  'card.capability.button.personal_contribute.update': '更新个人内容并申请共享给团队',
  'card.capability.button.bot.save': '保存到团队',
  'card.capability.button.bot.update': '更新团队内容',
  'card.capability.button.contribution.publish': '同意共享到团队',
  'card.capability.button.contribution.update': '同意更新团队内容',
  'card.capability.button.contribution.reject': '拒绝共享',
  'card.capability.button.delete.personal': '删除个人内容',
  'card.capability.button.delete.bot': '批准删除团队内容',
  'card.capability.button.delete.reject': '拒绝删除申请',
  'card.capability.button.cancel': '取消',
  'card.capability.result.saved.personal': '已保存到个人助手',
  'card.capability.result.saved.bot': '已保存到团队',
  'card.capability.result.deleted.personal': '已删除个人内容',
  'card.capability.result.deleted.bot': '已删除团队内容',
  'card.capability.result.cancelled': '已取消保存',
  'card.capability.result.delete_cancelled': '已取消删除',
  'card.capability.result.delete_rejected': '已拒绝删除申请',
  'card.capability.toast.stale': '该操作已失效，请重新发起。',
  'card.capability.toast.no_owner': '该机器人尚未配置 owner，无法申请共享给团队。',

  // Workflow trial card
  'card.workflow_trial.title': '请选择如何处理这个 Workflow 草稿',
  'card.workflow_trial.title.run': '已确认试运行 Workflow',
  'card.workflow_trial.title.edit': '将修改 Workflow 草稿',
  'card.workflow_trial.title.discard': '已放弃 Workflow 草稿',
  'card.workflow_trial.title.timeout': 'Workflow 试运行确认已超时',
  'card.workflow_trial.title.invalid': 'Workflow 试运行确认已失效',
  'card.workflow_trial.field.name': '名称',
  'card.workflow_trial.field.description': '说明',
  'card.workflow_trial.field.instructions': '流程',
  'card.workflow_trial.note': '此步骤仅确认是否试运行，不会保存 Workflow。试运行成功后会再显示保存确认卡片。',
  'card.workflow_trial.button.run': '试运行一次',
  'card.workflow_trial.button.discard': '放弃',
  'card.workflow_trial.custom_reply_hint': '💬 需要调整？直接在话题里回复修改要求。',
  'card.workflow_trial.result.run': 'Agent 将使用当前工具执行一次试运行。试运行成功后才会进入保存确认。',
  'card.workflow_trial.result.discard': '该草稿不会保存。',
  'card.workflow_trial.result.request': '修改要求',

  // Artifact overlap card
  'card.artifact_overlap.title': '发现相似内容，请选择处理方式',
  'card.artifact_overlap.title.update': '将更新已有内容',
  'card.artifact_overlap.title.separate': '将单独创建新内容',
  'card.artifact_overlap.title.cancel': '已取消创建',
  'card.artifact_overlap.title.revise': '将修改新内容',
  'card.artifact_overlap.title.timeout': '相似内容确认已超时',
  'card.artifact_overlap.title.invalid': '相似内容确认已失效',
  'card.artifact_overlap.field.type': '类型',
  'card.artifact_overlap.field.proposed': '准备创建',
  'card.artifact_overlap.field.existing': '最相似的已有内容',
  'card.artifact_overlap.field.summary': '重合与差异',
  'card.artifact_overlap.button.update': '更新已有内容',
  'card.artifact_overlap.button.separate': '仍单独创建',
  'card.artifact_overlap.button.cancel': '取消',
  'card.artifact_overlap.custom_reply_hint': '💬 需要其他处理方式？直接在话题里回复要求。',
  'card.artifact_overlap.result.update': 'Agent 将合并必要内容并更新已有 artifact。',
  ...
  'worker.codex_composer_conflict': '已 adopt 的 Codex 终端输入框里有未提交的本地草稿。我保留了它，没有把这条飞书消息拼到后面。请先提交或清空草稿，再重发飞书消息。',
  ...
  'worker.submit_unconfirmed_zmx': "⚠️ 等待 {secs}s 后，仍无法确认消息已送达 {cliName}。先不要重发，请在宿主机打开 ZMX 会话检查输入框。\n消息开头：{preview}",
  'worker.zmx_recovery_pending': "暂时无法确认 ZMX 会话状态，因此没有自动清理。先不要重发；请在宿主机检查会话，用 Ctrl+C 清空输入，再用 /restart 重启会话。",
  'worker.zmx_recovery_unconfirmed': "无法确认 ZMX 是否已清空输入。为避免重复或拼接消息，我已暂停自动写入。请在宿主机检查并清空输入，再用 /restart 重启会话。",
  'worker.interrupt_unconfirmed': '⚠️ 中断键 {key} 连续两次未送达 {cliName}，CLI 可能仍在运行；卡片不会把这次操作标成已停止。{recovery}',
  'worker.interrupt_recovery_zmx': "请在宿主机打开 ZMX 会话，检查并手动中断；如果状态仍不确定，请用 /restart 重启会话。",
  ...
  'restart.updated_restarted': "🔄 **已更新并重启**",
  'restart.rolled_back_restarted': "↩️ **已回退并重启**",
  'restart.restarted': "🔄 **已重启**",
