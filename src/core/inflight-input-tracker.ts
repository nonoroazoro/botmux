...
export class InflightInputTracker {
  ...
  /**
   * Find the input for an exact terminal without changing replay ownership.
   */
  findTurn(turnId: string, dispatchAttempt?: number): InflightItem | undefined {
    return this.unacked.find(item =>
